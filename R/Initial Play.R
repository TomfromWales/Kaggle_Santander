...
# Export
write.csv(preds_for_submission,paste0(data_folder,"/submissions/initial_play_submission_set1.csv"),row.names = FALSE)
write.csv(preds_for_submission_set2,paste0(data_folder,"/submissions/initial_play_submission_set2.csv"),row.names = FALSE)
